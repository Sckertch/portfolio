<template>
    <div class="profile-container">
        ...
        <section class="profile-section bts-options-section">
            <div class="section-header">
                <h2 class="section-title">Les deux options du BTS SIO</h2>
            </div>
            <div class="section-content">
                <div class="options-container">
                    <div class="option-card">
                        <div class="option-header">
                            <h3 class="option-title">Option SLAM</h3>
                            <span class="option-subtitle">Solutions Logicielles et Applications Métiers</span>
                        </div>
                        <div class="option-content">
                            <p>
                                L'option SLAM forme aux métiers du développement d'applications. Les étudiants
                                apprennent à:
                            </p>
                            ...
                            <p>
                                <strong>Technologies étudiées :</strong> Java, PHP, JavaScript, HTML/CSS, SQL, UML,
                                frameworks web,
                                méthodologies Agile...
                            </p>
                        </div>
                    ...
                    <div class="option-card">
                        <div class="option-header">
                            <h3 class="option-title">Option SISR</h3>
                            <span class="option-subtitle">Solutions d'Infrastructure, Systèmes et Réseaux</span>
                        </div>
                        <div class="option-content">
                            <p>
                                L'option SISR forme aux métiers liés aux infrastructures informatiques. Les étudiants
                                apprennent à:
                            </p>
                            <ul class="option-list">
                            ...
                            <p>
                                <strong>Technologies étudiées :</strong> Windows Server, Linux, TCP/IP, routage,
                                pare-feu, cloud
        ...
        <section class="profile-section bts-competences-section">
            <div class="section-header">
            ...
            <div class="section-content">
                <div class="competences-grid">
                    <div class="competence-item">
                        <h3 class="competence-title">Compétences techniques</h3>
                    ...
                    <div class="competence-item">
                        <h3 class="competence-title">Compétences méthodologiques</h3>
                        <ul class="competence-list">
                    ...
                    <div class="competence-item">
                        <h3 class="competence-title">Compétences transversales</h3>
                        <ul class="competence-list">
        ...
        <section class="profile-section bts-debouches-section">
            <div class="section-header">
            ...
            <div class="section-content">
                <div class="debouches-container">
                    <div class="debouche-card">
                        <h3 class="debouche-title">Débouchés SLAM</h3>
                        <ul class="debouche-list">
                    ...
                    <div class="debouche-card">
                        <h3 class="debouche-title">Débouchés SISR</h3>
                        <ul class="debouche-list">
                    ...
                    <div class="debouche-card">
                        <h3 class="debouche-title">Poursuites d'études</h3>
                        <ul class="debouche-list">
...
onMounted(() => {
    // Configurer l'animation au défilement
